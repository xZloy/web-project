    ...
    <?php  include 'conn.php';
        ...
        while($row = mysqli_fetch_array($sql)){ 
            ...
            <tr class="product-row">
                ...
                <td class="actions">
                    <a href="editar_producto.php?id=<?php echo $fila['id']; ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                    <a href="eliminar_producto.php?id=<?php echo $fila['id']; ?>"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
        <?php } ?>
